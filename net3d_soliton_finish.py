...
print("=== A: low density (no jams), long ===")
run(1.00, 60, 20000, "A-60 ", 41, cp_long)
print("\n=== B: working density, long ===")
run(1.00, 300, 20000, "B-300", 43, cp_long)
print("\n=== C: open arc, MU=8 ===")
run(0.667, 200, 8000, "C-arc", 47, (1000, 3000, 6000, 8000))
